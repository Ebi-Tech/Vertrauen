    ...
    <main className={styles.container}>
      ...
      <section className={styles.teamSection}>
        ...
        <div className={styles.teamMember}>
          <h3 className={styles.teamMemberTitle}>Our Values</h3>
       <p className={styles.teamMemberText}>The values that drive us: Confidence, Trust, Innovation and Resilience. Confidence propels action, resilience sustains motivation, trust fosters collaboration, and innovation drives transformation.When these four forces converge, they can create victory.</p>
        </div>
